...
insert into cd(id, title, artist_id, catalogue) values (1, 'Dark Side of the Moon', 1, 'BOOOO24D4P');
...
insert into track (cd_id, track_id, title) values (2,5,'Shine on you crazy diamonds');
